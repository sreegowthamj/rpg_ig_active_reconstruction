...
boost::shared_ptr< INPUT_OBJ_TYPE<TREE_TYPE> > CSCOPE::getLinkedObj(
CONSTRUCTOR_ARGS ... args )
{
  boost::shared_ptr< INPUT_OBJ_TYPE<TREE_TYPE> > ptr = boost::make_shared<
INPUT_OBJ_TYPE<TREE_TYPE> >( args... );
...
CSCOPE::getLinkedObj(typename INPUT_OBJ_TYPE<TREE_TYPE>::Type::Config config) {
  boost::shared_ptr<typename INPUT_OBJ_TYPE<TREE_TYPE>::Type> ptr =
      boost::make_shared<typename INPUT_OBJ_TYPE<TREE_TYPE>::Type>(config);
