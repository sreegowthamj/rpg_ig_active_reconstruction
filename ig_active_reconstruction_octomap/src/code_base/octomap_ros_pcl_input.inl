...
{
        pcl_subscriber_ = nh_.subscribe("pcl_input", 10,
                                        &CSCOPE::insertCloudCallback, this);
        pcl_input_service_ = nh_.advertiseService(
                "pcl_input", &CSCOPE::insertCloudService, this);
}
...
void CSCOPE::insertCloud(POINTCLOUD_TYPE &pointcloud)
{
        ...
        try {
                tf_listener_.lookupTransform(world_frame_name_,
