...
int main(int argc, char **argv) {
  ...
  ros_tools::getParamIfAvailable<float, double>(
      input_config.bounding_box_min_point_m.x(), "bounding_box_min_point_m/x");
  ros_tools::getParamIfAvailable<float, double>(
      input_config.bounding_box_min_point_m.y(), "bounding_box_min_point_m/y");
  ros_tools::getParamIfAvailable<float, double>(
      input_config.bounding_box_min_point_m.z(), "bounding_box_min_point_m/z");
  ros_tools::getParamIfAvailable<float, double>(
      input_config.bounding_box_max_point_m.x(), "bounding_box_max_point_m/x");
  ros_tools::getParamIfAvailable<float, double>(
      input_config.bounding_box_max_point_m.y(), "bounding_box_max_point_m/y");
  ros_tools::getParamIfAvailable<float, double>(
      input_config.bounding_box_max_point_m.z(), "bounding_box_max_point_m/z");
  ...
  ros_tools::getParamIfAvailable<unsigned int, int>(
      ig_calc_config.ray_caster_config.img_height_px, "img_height_px");
  ros_tools::getParamIfAvailable(
      ig_calc_config.ray_caster_config.camera_matrix(0, 0), "camera/fx");
  ros_tools::getParamIfAvailable(
      ig_calc_config.ray_caster_config.camera_matrix(1, 1), "camera/fy");
  ros_tools::getParamIfAvailable(
      ig_calc_config.ray_caster_config.camera_matrix(0, 2), "camera/cx");
  ros_tools::getParamIfAvailable(
      ig_calc_config.ray_caster_config.camera_matrix(1, 2), "camera/cy");
  ros_tools::getParamIfAvailable(
      ig_calc_config.ray_caster_config.max_ray_depth_m, "max_ray_depth_m");
  ...
  typename StdPclInputPointXYZ<TreeType>::Ptr std_input =
      world_representation.getLinkedObj<StdPclInputPointXYZ>(input_config);
  ...
  // .............................................................................................
  BasicRayIgCalculator<IgTreeWorldRepresentation::TreeType>::Ptr ig_calculator =
      world_representation.getLinkedObj<BasicRayIgCalculator>(ig_calc_config);
