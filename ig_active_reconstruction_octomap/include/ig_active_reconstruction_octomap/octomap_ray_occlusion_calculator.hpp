...
public:
  ...
  public:
    double occlusion_update_dist_m; //! Max distance behind points along ray for
                                    //! which an occlusion will be calculated
                                    //! [m].
  };
...
protected:
  double occlusion_update_dist_m_; //! Max distance behind points along ray for
                                   //! which an occlusion will be calculated
                                   //! [m].
};
}
