...
public:
  ...
  typedef
      typename IgCalculator<TREE_TYPE>::IgRetrievalCommand IgRetrievalCommand;
  ...
  public:
    PinholeCamRayCaster::Config
        ray_caster_config; //! Configuration for the pinhole ray casting module.
  };
...
protected:
  struct RayCastSettings {
    ...
    // double occupied_passthrough_threshold; //! If an occupied voxel's
    // occupancy likelihood is lower than this threshold, ray casting is
    // continued.
