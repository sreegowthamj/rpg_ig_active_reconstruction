...
class BasicRayIgCalculator : public IgCalculator<TREE_TYPE>
{
      public:
        ...
        typedef typename IgCalculator<TREE_TYPE>::ResultInformation
                ResultInformation;
        typedef typename IgCalculator<TREE_TYPE>::IgRetrievalCommand
                IgRetrievalCommand;
        typedef typename IgCalculator<TREE_TYPE>::IgRetrievalResult
                IgRetrievalResult;
        typedef typename IgCalculator<TREE_TYPE>::MapMetricRetrievalCommand
                MapMetricRetrievalCommand;
        typedef typename IgCalculator<TREE_TYPE>::MapMetricRetrievalResult
                MapMetricRetrievalResult;
        typedef typename IgCalculator<TREE_TYPE>::MetricInfo MetricInfo;
        typedef typename IgCalculator<TREE_TYPE>::ViewIgRetrievalResult
                ViewIgRetrievalResult;
        typedef typename IgCalculator<TREE_TYPE>::MapMetricRetrievalResultSet
        ...
        struct Config {
              ...
              public:
                PinholeCamRayCaster::Config
                        ray_caster_config; //! Configuration for the pinhole ray
                                           //! casting module.
        };
      ...
      public:
        ...
        computeViewIg(IgRetrievalCommand &command,
      ...
      protected:
        struct RayCastSettings {
                // double min_ray_depth; //! Minimal ray length (where it
                // starts).
