 ...
 */
template <class TREE_TYPE, class POINTCLOUD_TYPE> class RosPclInput
{
      public:
        /*! Constructor.
         * @param nh ros node handle under which topic and service will be
         * advertised.
         * @param pcl_input PclInput object pointer to which pointclouds are
         * forwarded.
         * @param world_frame Name of the world coordinate frame to which the
      ...
      protected:
         ...
         */
        void
        insertCloudCallback(const sensor_msgs::PointCloud2::ConstPtr &cloud);

        /*! Pcl input service.
         */
        bool insertCloudService(
                ig_active_reconstruction_msgs::PclInput::Request &req,
                ig_active_reconstruction_msgs::PclInput::Response &res);

        /*! Helper function calling the signal call stack.
         */
        void issueInputDoneSignals();

        /*! Inserts a cloud by reference and calls issueInputDoneSignals when
         * done.
         */
