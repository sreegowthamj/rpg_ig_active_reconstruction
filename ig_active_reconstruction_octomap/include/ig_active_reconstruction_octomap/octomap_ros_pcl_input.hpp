...
public:
   ...
   * forwarded.
   * @param world_frame Name of the world coordinate frame to which the incoming
   * pointclouds will be transformed.
   */
...
protected:
   ...
   */
  bool
  insertCloudService(ig_active_reconstruction_msgs::PclInput::Request &req,
