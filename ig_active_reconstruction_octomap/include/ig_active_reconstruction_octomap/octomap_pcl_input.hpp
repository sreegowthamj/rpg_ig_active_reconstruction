...
class PclInput : public WorldRepresentation<TREE_TYPE>::LinkedObject
{
      public:
        ...
        /*! Inserts a new pointcloud. If an occlusion calculator was set, it is
         * called at the end.
         *
         * @param sensor_to_world Transform from sensor to world coordinates.
         * @param pcl The pointcloud that is to be inserted, in sensor
         * coordinates. Note that the function will operate directly on it
         */
        virtual void
        push(const Eigen::Transform<double, 3, Eigen::Affine> &sensor_to_world,
             POINTCLOUD_TYPE &pcl) = 0;

        /*! (for when cpp11 is enabled) Adds an occlusion calculator that will
         * be called at the end of pointcloud insertions. It is expected to
         * derive from OcclusionCalculator and to take two template arguments:
         * TREE_TYPE and POINTCLOUD_TYPE.
         *
         * Usage of the function is similar to std::make_shared, but you can
         * omit the two template arguments. E.g.
        ...
        ... Types > void setOcclusionCalculator( Types ... args );*/

        /*! Adds an occlusion calculator that will be called at the end of
         * pointcloud insertions. It is expected to derive from
         * OcclusionCalculator and to take two template arguments: TREE_TYPE and
         * POINTCLOUD_TYPE which will be set automatically. It must have an
         * Options member type which it takes a construction argument.
         */
