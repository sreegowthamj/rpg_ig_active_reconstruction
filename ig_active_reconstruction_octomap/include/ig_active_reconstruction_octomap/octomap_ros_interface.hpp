 ...
 * providing common functionality like publishers and services. Inputs (e.g.
 * pcl) are not provided as these are supposed to be provided by dedicated
 * classes in order to allow a multiple sensor and multiple sensor modality
 * approach.
 */
...
class RosInterface : public WorldRepresentation<TREE_TYPE>::LinkedObject
{
      ...
      protected:
        ...
        // OctomapSrv::GetOctomap::Response &res); virtual bool
        // octomapFullSrv(OctomapSrv::Request  &req,
        // OctomapSrv::GetOctomap::Response &res); bool
        // clearBBXSrv(BBXSrv::Request& req, BBXSrv::Response& resp); bool
        // resetSrv(std_srvs::Empty::Request& req, std_srvs::Empty::Response&
        // resp);
