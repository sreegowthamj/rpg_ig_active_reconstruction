...
class VasquezGomezAreaFactorIg : public InformationGain<TREE_TYPE>
{
        ...
        class Utils : public InformationGain<TREE_TYPE>::Utils
        {
              public:
                struct LocalConfig {
                      ...
                      public:
                        double p_occupied_des_; //! Desired occupancy
                                                //! percentage. Default: 0.2
                        double p_occplane_des_; //! Desired occplane percentage.
                                                //! Default: 0.8
                } vasquez_config;
      ...
      protected:
        ...
        /*! Helper function to speed up calculations: Precomputes needed
         * coefficients for a given alpha.
         */
        void setCoefficients(double alpha, double &a_f1, double &b_f1,
                             double &a_f2, double &b_f2, double &c_f2,
                             double &d_f2);

        /*! Area factor function as defined in paper with precalculated
         * coefficients for occupied voxel percentage.
         * @return The area factor.
         */
        double areaFactorOccupied(double percentage);

        /*! Area factor function as defined in paper with precalculated
         * coefficients for occplane voxel percentage.
         * @return The area factor.
         */
      ...
      private:
        ...
        uint64_t voxel_count_; //! Voxels integrated for the information gain
                               //! calculation.
