...
private:
  ...
  double p_vis_; //! Running visibility likelihood along a ray. (Representing
                 //! the visibility likelihood of the next voxel.)
  uint64_t voxel_count_; //! Counts the total number of considered voxels during
                         //! the current run.
};
}
}
