 ...
 * by weighting the entropy within each voxel by its visibility likelihood and
 * restricts the area that is considered to such on the rear side of already
 * observed surfaces.
 */
...
class RearSideEntropyIg : public InformationGain<TREE_TYPE>
{
      ...
      private:
        ...
        uint64_t current_ray_voxel_count_; //! Number of voxels integrated for
                                           //! calculation.
