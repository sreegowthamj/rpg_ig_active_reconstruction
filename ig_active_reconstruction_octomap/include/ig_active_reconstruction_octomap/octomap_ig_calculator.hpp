                     ...
                     public WorldRepresentation<TREE_TYPE>::LinkedObject
{
      ...
      public:
        ...
        computeViewIg(IgRetrievalCommand &command,
                      ViewIgRetrievalResult &output_ig) = 0;
         ...
         * Registers an information gains with optional constructor parameters
         * that will then be available for calculations.
         *
         ...
         *
         * @tparam IG_METRIC_TYPE Type of the information gain that is to be
         * created. It must be templated on the TREE_TYPE, which will be
         * automatically matched to the one of the IgCalculator object.
         * @param args (variadic) Constructor arguments to the created
         * IG_METRIC_TYPE, used for custom configuration.
         ...
         * It must take the TREE_TYPE as its only template argument which is
         * being set automatically.
         */
        template <template <typename> class IG_METRIC_TYPE>
        unsigned int registerInformationGain(
