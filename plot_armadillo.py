...
#y_metric1 = np.genfromtxt('./map_metric_data/40iters_armadillo/metric1/occupied_voxel_area.csv', delimiter=',')
#y_metric1 = y_metric1[~np.isnan(y_metric1)]

y_RearSideEntropyIg = np.genfromtxt('./map_metric_data/40iters_armadillo/RearSideEntropyIg/occupied_voxel_area.csv', delimiter=',')
y_RearSideEntropyIg = y_RearSideEntropyIg[~np.isnan(y_RearSideEntropyIg)]


y_AverageEntropyIg = np.genfromtxt('./map_metric_data/40iters_armadillo/AverageEntropyIg/occupied_voxel_area.csv', delimiter=',')
y_AverageEntropyIg = y_AverageEntropyIg[~np.isnan(y_AverageEntropyIg)]



y_OcclusionAwareIg = np.genfromtxt('./map_metric_data/40iters_armadillo/OcclusionAwareIg/occupied_voxel_area.csv', delimiter=',')
y_OcclusionAwareIg = y_OcclusionAwareIg[~np.isnan(y_OcclusionAwareIg)]


y_ProximityCountIg = np.genfromtxt('./map_metric_data/40iters_armadillo/ProximityCountIg/occupied_voxel_area.csv', delimiter=',')
y_ProximityCountIg = y_ProximityCountIg[~np.isnan(y_ProximityCountIg)]


y_RearSideVoxelIg = np.genfromtxt('./map_metric_data/40iters_armadillo/RearSideVoxelIg/occupied_voxel_area.csv', delimiter=',')
y_RearSideVoxelIg = y_RearSideVoxelIg[~np.isnan(y_RearSideVoxelIg)]


y_UnobservedVoxelIg = np.genfromtxt('./map_metric_data/40iters_armadillo/UnobservedVoxelIg/occupied_voxel_area.csv', delimiter=',')
y_UnobservedVoxelIg = y_UnobservedVoxelIg[~np.isnan(y_UnobservedVoxelIg)]


y_VasquezGomezAreaFactorIg = np.genfromtxt('./map_metric_data/40iters_armadillo/VasquezGomezAreaFactorIg/occupied_voxel_area.csv', delimiter=',')
y_VasquezGomezAreaFactorIg = y_VasquezGomezAreaFactorIg[~np.isnan(y_VasquezGomezAreaFactorIg)]


y_UnknownVoxelCountIg = np.genfromtxt('./map_metric_data/40iters_armadillo/UnknownVoxelCountIg/occupied_voxel_area.csv', delimiter=',')
y_UnknownVoxelCountIg = y_UnknownVoxelCountIg[~np.isnan(y_UnknownVoxelCountIg)]

#y_DynamicExploreExploitIg = np.genfromtxt('./map_metric_data/40iters_armadillo/DynamicExploreExploitIg/occupied_voxel_area.csv', delimiter=',')
...
plt.plot(xdata, y_UnknownVoxelCountIg, '.r', label='DynamicExploreExploitIg')
