...
KinematicMovementDescription::KinematicMovementDescription(
    KinematicMovementDescriptionInstance *_to_enwrap) {
  enwrapped_kinematic_movement_description_ =
      boost::shared_ptr<KinematicMovementDescriptionInstance>(_to_enwrap);
}
...
boost::shared_ptr<
    KinematicMovementDescription::KinematicMovementDescriptionInstance>
    KinematicMovementDescription::operator->() {
...
std::vector<RelativeMovement>
KinematicMovementDescription::relativePath(double _start_time, double _end_time,
                                           double _step_size) {
  if (_step_size <= 0) {
    throw std::invalid_argument("KinematicMovementDescription::relativePath::"
...
KinematicMovementDescription::path(movements::Pose _base_pose,
                                   double _start_time, double _end_time,
                                   double _step_size) {
  if (_step_size <= 0) {
    throw std::invalid_argument("KinematicMovementDescription::path::Called "
...
std::vector<RelativeMovement>
KinematicMovementDescription::KinematicMovementDescriptionInstance::
    relativePath(double _start_time, double _end_time, double _step_size) {
...
movements::PoseVector
KinematicMovementDescription::KinematicMovementDescriptionInstance::path(
    movements::Pose _base_pose, double _start_time, double _end_time,
    double _step_size) {
