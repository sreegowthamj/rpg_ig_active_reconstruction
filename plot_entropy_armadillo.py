...
#y_metric1 = np.genfromtxt('./map_metric_data/40iters_bunny/metric1/entropy.csv', delimiter=',')
#y_metric1 = y_metric1[~np.isnan(y_metric1)]


y_RearSideEntropyIg = np.genfromtxt('./map_metric_data/entropy_armadillo/RearSideEntropyIg/entropy.csv', delimiter=',')
y_RearSideEntropyIg = y_RearSideEntropyIg[~np.isnan(y_RearSideEntropyIg)]


y_AverageEntropyIg = np.genfromtxt('./map_metric_data/entropy_armadillo/AverageEntropyIg/entropy.csv', delimiter=',')
y_AverageEntropyIg = y_AverageEntropyIg[~np.isnan(y_AverageEntropyIg)]



y_OcclusionAwareIg = np.genfromtxt('./map_metric_data/entropy_armadillo/OcclusionAwareIg/entropy.csv', delimiter=',')
y_OcclusionAwareIg = y_OcclusionAwareIg[~np.isnan(y_OcclusionAwareIg)]


y_ProximityCountIg = np.genfromtxt('./map_metric_data/entropy_armadillo/ProximityCountIg/entropy.csv', delimiter=',')
y_ProximityCountIg = y_ProximityCountIg[~np.isnan(y_ProximityCountIg)]


y_RearSideVoxelIg = np.genfromtxt('./map_metric_data/entropy_armadillo/RearSideVoxelIg/entropy.csv', delimiter=',')
y_RearSideVoxelIg = y_RearSideVoxelIg[~np.isnan(y_RearSideVoxelIg)]


y_UnobservedVoxelIg = np.genfromtxt('./map_metric_data/entropy_armadillo/UnobservedVoxelIg/entropy.csv', delimiter=',')
y_UnobservedVoxelIg = y_UnobservedVoxelIg[~np.isnan(y_UnobservedVoxelIg)]


y_VasquezGomezAreaFactorIg = np.genfromtxt('./map_metric_data/entropy_armadillo/VasquezGomezAreaFactorIg/entropy.csv', delimiter=',')
y_VasquezGomezAreaFactorIg = y_VasquezGomezAreaFactorIg[~np.isnan(y_VasquezGomezAreaFactorIg)]


y_UnknownVoxelCountIg = np.genfromtxt('./map_metric_data/entropy_armadillo/UnknownVoxelCountIg/entropy.csv', delimiter=',')
y_UnknownVoxelCountIg = y_UnknownVoxelCountIg[~np.isnan(y_UnknownVoxelCountIg)]

#y_DynamicExploreExploitIg = np.genfromtxt('./map_metric_data/entropy_armadillo/DynamicExploreExploitIg/entropy.csv', delimiter=',')
...
#plt.plot(xdata, y_DynamicExploreExploitIg,'-.r', label='DynamicExploreExploitIg')
