 ...
 *
 * Uses the ROS communication interface (topics, services etc.) to forward
 * requests.
 */
class RosClientCI : public CommunicationInterface {
public:
  /*! Constructor
   * @param nh_sub ROS node handle defines the namespace in which ROS
   * communication will be carried out for any topic or service subscribers.
   */
