 ...
 * @param nodeHandle Node handle (defaults to a private ROS node handle:
 * ros::NodeHandle("~") )
 */
 ...
 * wasn't found and the default is used, a warning is issued.
 *
 * Function is overloaded for one or two template parameters: the version with
 * two provides the following functionality: If the target value is of a type
 * that
...
/*! Template function to load a parameter with included default value. If it
 * wasn't found the value is not set.
 *
 * Function is overloaded for one or two template parameters: the version with
 * two provides the following functionality: If the target value is of a type
 * that
