...
RosServerCI::RosServerCI(
  ...
  viewspace_service_ =
      nh.advertiseService("views/space", &RosServerCI::viewspaceService, this);
  views_adder_service_ =
      nh.advertiseService("views/add", &RosServerCI::viewsAdderService, this);
...
RosServerCI::ViewSpaceUpdateResult
RosServerCI::deleteView(View::IdType view_id) {
  if (linked_interface_ == nullptr)
    throw std::runtime_error("views::RosServerCI::Interface not linked.");
