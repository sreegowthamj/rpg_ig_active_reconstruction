...
igRetrievalConfigFromMsg(
        ig_active_reconstruction_msgs::InformationGainRetrievalConfig
                &config_msg)
{
...
igRetrievalCommandFromMsg(
        ig_active_reconstruction_msgs::InformationGainRetrievalCommand
                &command_msg)
{
        world_representation::CommunicationInterface::IgRetrievalCommand
                command;
...
world_representation::CommunicationInterface::ResultInformation
resultInformationFromMsg(int &msg)
{
        switch (msg) {
        case 0:
                return world_representation::CommunicationInterface::
                        ResultInformation::SUCCEEDED;
        case 1:
                return world_representation::CommunicationInterface::
                        ResultInformation::FAILED;
        case 2:
                return world_representation::CommunicationInterface::
                        ResultInformation::UNKNOWN_METRIC;
        default:
                throw std::invalid_argument(
                        "ig_active_reconstruction::ros_conversions::resultInformationFromMsg:: Invalid status received.");
        };
}

int resultInformationToMsg(
        world_representation::CommunicationInterface::ResultInformation &msg)
{
        switch (msg) {
        case world_representation::CommunicationInterface::ResultInformation::
                SUCCEEDED:
                return 0;
        case world_representation::CommunicationInterface::ResultInformation::
                FAILED:
        ...
        default:
                throw std::invalid_argument(
                        "ig_active_reconstruction::ros_conversions::resultInformationToMsg:: Invalid status received.");
        };
}

world_representation::CommunicationInterface::IgRetrievalResult
igRetrievalResultFromMsg(ig_active_reconstruction_msgs::InformationGain &msg)
{
...
ig_active_reconstruction_msgs::InformationGain igRetrievalResultToMsg(
        world_representation::CommunicationInterface::IgRetrievalResult &result)
{
