...
resultInformationFromMsg(int &msg) {
  switch (msg) {
  case 0:
    return world_representation::CommunicationInterface::ResultInformation::
        SUCCEEDED;
  case 1:
    return world_representation::CommunicationInterface::ResultInformation::
        FAILED;
  case 2:
    return world_representation::CommunicationInterface::ResultInformation::
        UNKNOWN_METRIC;
  default:
    throw std::invalid_argument("ig_active_reconstruction::ros_conversions::"
                                "resultInformationFromMsg:: Invalid status "
                                "received.");
  };
}
...
int resultInformationToMsg(
  ...
  case world_representation::CommunicationInterface::ResultInformation::
      SUCCEEDED:
    return 0;
  case world_representation::CommunicationInterface::ResultInformation::FAILED:
    return 1;
  case world_representation::CommunicationInterface::ResultInformation::
      UNKNOWN_METRIC:
    return 2;
  default:
    throw std::invalid_argument("ig_active_reconstruction::ros_conversions::"
                                "resultInformationToMsg:: Invalid status "
                                "received.");
  };
}
