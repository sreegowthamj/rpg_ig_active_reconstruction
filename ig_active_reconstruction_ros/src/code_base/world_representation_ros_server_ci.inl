...
CSCOPE::RosServerCI(ros::NodeHandle nh,
  ...
  available_ig_receiver_ =
      nh.advertiseService("world/ig_list", &CSCOPE::availableIgService, this);
  available_mm_receiver_ =
      nh.advertiseService("world/mm_list", &CSCOPE::availableMmService, this);
}
...
TEMPT
void CSCOPE::availableMapMetrics(
...
bool CSCOPE::igComputationService(
    ...
    ig_active_reconstruction_msgs::InformationGainCalculation::Response &res) {
  ...
  if (linked_interface_ == NULL) {
    ...
    unsigned int number_of_metrics = (!req.command.metric_ids.empty())
