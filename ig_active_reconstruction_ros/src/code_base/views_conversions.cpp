...
views::CommunicationInterface::ViewSpaceStatus
viewSpaceStatusFromMsg(int &msg) {
  switch (msg) {
  case 0:
    return views::CommunicationInterface::ViewSpaceStatus::OK;
  case 1:
    return views::CommunicationInterface::ViewSpaceStatus::BAD;
  case 2:
    return views::CommunicationInterface::ViewSpaceStatus::NONE_AVAILABLE;
  default:
...
int viewSpaceStatusToMsg(
  ...
  switch (status) {
  case views::CommunicationInterface::ViewSpaceStatus::OK:
    return 0;
  case views::CommunicationInterface::ViewSpaceStatus::BAD:
    return 1;
  case views::CommunicationInterface::ViewSpaceStatus::NONE_AVAILABLE:
    return 2;
  default:
    throw std::invalid_argument("ig_active_reconstruction::ros_conversions::"
...
viewSpaceUpdateResultFromMsg(int &msg) {
  switch (msg) {
  case 0:
    return views::CommunicationInterface::ViewSpaceUpdateResult::SUCCEEDED;
  case 1:
    return views::CommunicationInterface::ViewSpaceUpdateResult::FAILED;
  case 2:
    return views::CommunicationInterface::ViewSpaceUpdateResult::NOT_AVAILABLE;
  };
}
...
int viewSpaceUpdateResultToMsg(
  ...
  switch (res) {
  case views::CommunicationInterface::ViewSpaceUpdateResult::SUCCEEDED:
    return 0;
  case views::CommunicationInterface::ViewSpaceUpdateResult::FAILED:
    return 1;
  case views::CommunicationInterface::ViewSpaceUpdateResult::NOT_AVAILABLE:
    return 2;
  };
}
}
