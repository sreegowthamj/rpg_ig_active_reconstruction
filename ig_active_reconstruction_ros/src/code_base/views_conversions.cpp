...
views::CommunicationInterface::ViewSpaceStatus viewSpaceStatusFromMsg(int &msg)
{
        ...
        case 2:
                return views::CommunicationInterface::ViewSpaceStatus::
                        NONE_AVAILABLE;
        default:
...
viewSpaceUpdateResultFromMsg(int &msg)
{
        switch (msg) {
        case 0:
                return views::CommunicationInterface::ViewSpaceUpdateResult::
                        SUCCEEDED;
        case 1:
                return views::CommunicationInterface::ViewSpaceUpdateResult::
                        FAILED;
        ...
        views::CommunicationInterface::ViewSpaceUpdateResult &res)
{
        ...
        case views::CommunicationInterface::ViewSpaceUpdateResult::FAILED:
                return 1;
        case views::CommunicationInterface::ViewSpaceUpdateResult::
                NOT_AVAILABLE:
                return 2;
        };
}
