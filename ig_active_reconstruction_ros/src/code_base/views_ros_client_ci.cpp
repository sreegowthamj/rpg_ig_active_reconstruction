...
RosClientCI::RosClientCI(ros::NodeHandle nh) : nh_(nh) {
  planning_space_receiver_ =
      nh.serviceClient<ig_active_reconstruction_msgs::ViewSpaceRequest>(
          "views/space");
  views_adder_ =
      nh.serviceClient<ig_active_reconstruction_msgs::ViewSpaceUpdate>(
          "views/add");
  views_deleter_ = nh.serviceClient<ig_active_reconstruction_msgs::DeleteViews>(
      "views/delete");
}
...
RosClientCI::ViewSpaceUpdateResult
RosClientCI::deleteView(View::IdType view_id) {
  ig_active_reconstruction_msgs::DeleteViews call;
