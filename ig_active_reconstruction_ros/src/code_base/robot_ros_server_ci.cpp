...
RosServerCI::RosServerCI(
  ...
  data_service_ = nh_.advertiseService("robot/retrieve_data",
                                       &RosServerCI::retrieveDataService, this);
  cost_service_ = nh_.advertiseService("robot/movement_cost",
                                       &RosServerCI::movementCostService, this);
  robot_moving_service_ =
      nh_.advertiseService("robot/move_to", &RosServerCI::moveToService, this);
}
