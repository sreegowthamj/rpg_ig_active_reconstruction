...
RosServerCI::RosServerCI(
        ros::NodeHandle nh,
        boost::shared_ptr<CommunicationInterface> linked_interface)
    : nh_(nh), linked_interface_(linked_interface)
{
        current_view_service_ = nh_.advertiseService(
                "robot/current_view", &RosServerCI::currentViewService, this);
        data_service_ = nh_.advertiseService(
                "robot/retrieve_data", &RosServerCI::retrieveDataService, this);
        cost_service_ = nh_.advertiseService(
                "robot/movement_cost", &RosServerCI::movementCostService, this);
        robot_moving_service_ = nh_.advertiseService(
                "robot/move_to", &RosServerCI::moveToService, this);
}
...
views::View RosServerCI::getCurrentView()
{
        if (linked_interface_ == nullptr)
                throw std::runtime_error(
                        "robot::RosServerCI::Interface not linked.");
...
MovementCost RosServerCI::movementCost(views::View &start_view,
                                       ...
                                       bool fill_additional_information)
{
        ...
        return linked_interface_->movementCost(start_view, target_view,
                                               fill_additional_information);
}
...
bool RosServerCI::currentViewService(
        ig_active_reconstruction_msgs::ViewRequest::Request &req,
        ig_active_reconstruction_msgs::ViewRequest::Response &res)
{
...
bool RosServerCI::retrieveDataService(
        ig_active_reconstruction_msgs::RetrieveData::Request &req,
        ig_active_reconstruction_msgs::RetrieveData::Response &res)
{
        ROS_INFO("Received 'retrieve data' call.");
        if (linked_interface_ == nullptr) {
                ReceptionInfo inf = ReceptionInfo::FAILED;
                res.receive_info =
                        ros_conversions::robotReceptionInfoToMsg(inf);
                return true;
        }
...
bool RosServerCI::movementCostService(
        ig_active_reconstruction_msgs::MovementCostCalculation::Request &req,
        ig_active_reconstruction_msgs::MovementCostCalculation::Response &res)
{
        ...
        if (linked_interface_ == nullptr) {
                ...
                views::View start_view =
                        ros_conversions::viewFromMsg(req.start_view);
                views::View target_view =
                        ros_conversions::viewFromMsg(req.target_view);
                bool fill_additional_info = req.additional_information;

                cost = linked_interface_->movementCost(start_view, target_view,
...
bool RosServerCI::moveToService(
        ig_active_reconstruction_msgs::MoveToOrder::Request &req,
        ig_active_reconstruction_msgs::MoveToOrder::Response &res)
{
