...
/*! Implements a ROS node holding a BasicViewPlanner, combined with a simple
...
int main(int argc, char **argv)
{
        ...
        ros_tools::getParam(bvp_config.discard_visited, "discard_visited",
                            false);
        ...
        // ...................................................................................................................
        boost::shared_ptr<iar::robot::CommunicationInterface> robot_comm =
                boost::make_shared<iar::robot::RosClientCI>(nh);
        boost::shared_ptr<iar::views::CommunicationInterface> views_comm =
                boost::make_shared<iar::views::RosClientCI>(nh);
        boost::shared_ptr<iar::world_representation::CommunicationInterface>
                world_comm = boost::make_shared<
                        iar::world_representation::RosClientCI>(nh);
        ...
        // ...................................................................................................................
        boost::shared_ptr<iar::WeightedLinearUtility> utility_calculator =
        ...
        for (unsigned int i = 0; i < ig_names.size() && i < ig_weights.size();
             ++i) {
                std::cout << "\nUsing information gain '" << ig_names[i]
                          << "' with weight '" << ig_weights[i] << "'.";
                utility_calculator->useInformationGain(ig_names[i],
                                                       ig_weights[i]);
        }
