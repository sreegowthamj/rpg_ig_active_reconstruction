...
y_RearSideEntropyIg = np.genfromtxt('./map_metric_data/entropy_bunny/RearSideEntropyIg/entropy.csv', delimiter=',')
y_RearSideEntropyIg = y_RearSideEntropyIg[~np.isnan(y_RearSideEntropyIg)]


y_AverageEntropyIg = np.genfromtxt('./map_metric_data/entropy_bunny/AverageEntropyIg/entropy.csv', delimiter=',')
y_AverageEntropyIg = y_AverageEntropyIg[~np.isnan(y_AverageEntropyIg)]



y_OcclusionAwareIg = np.genfromtxt('./map_metric_data/entropy_bunny/OcclusionAwareIg/entropy.csv', delimiter=',')
y_OcclusionAwareIg = y_OcclusionAwareIg[~np.isnan(y_OcclusionAwareIg)]


y_ProximityCountIg = np.genfromtxt('./map_metric_data/entropy_bunny/ProximityCountIg/entropy.csv', delimiter=',')
y_ProximityCountIg = y_ProximityCountIg[~np.isnan(y_ProximityCountIg)]


y_RearSideVoxelIg = np.genfromtxt('./map_metric_data/entropy_bunny/RearSideVoxelIg/entropy.csv', delimiter=',')
y_RearSideVoxelIg = y_RearSideVoxelIg[~np.isnan(y_RearSideVoxelIg)]


y_UnobservedVoxelIg = np.genfromtxt('./map_metric_data/entropy_bunny/UnobservedVoxelIg/entropy.csv', delimiter=',')
y_UnobservedVoxelIg = y_UnobservedVoxelIg[~np.isnan(y_UnobservedVoxelIg)]


y_VasquezGomezAreaFactorIg = np.genfromtxt('./map_metric_data/entropy_bunny/VasquezGomezAreaFactorIg/entropy.csv', delimiter=',')
y_VasquezGomezAreaFactorIg = y_VasquezGomezAreaFactorIg[~np.isnan(y_VasquezGomezAreaFactorIg)]


y_UnknownVoxelCountIg = np.genfromtxt('./map_metric_data/entropy_bunny/UnknownVoxelCountIg/entropy.csv', delimiter=',')
y_UnknownVoxelCountIg = y_UnknownVoxelCountIg[~np.isnan(y_UnknownVoxelCountIg)]

#y_DynamicExploreExploitIg = np.genfromtxt('./map_metric_data/entropy_bunny/DynamicExploreExploitIg/entropy.csv', delimiter=',')
