...
class ViewSpace
{
      public:
        ...
        class Iterator; // forward declaration for bidirectional iterator type
                        // to View
        // typedef std::map<View::IdType, View >::const_iterator ConstIterator;
        class ConstIterator; // forward declaration for bidirectional iterator
                             // type to const View
      ...
      public:
         ...
         * visited.
         * @param ignore_visited whether already visited views are left out of
         * the "good viewspace" or not
         */
         ...
         * @return True if all views were found (and deleted). If it is false,
         * some may still have been deleted.
         */
        bool deleteViews(std::vector<View::IdType> &index_set);

        /*!
         * returns how many times the view with index _index has already been
         * visited
        ...
        /*! returns the view closest to the position passed, ignoring
         * orientation. If more than one views in the view space have the same
         * distance, the first found is returned
...
{
      public:
        typedef std::map<View::IdType, View>::const_iterator
