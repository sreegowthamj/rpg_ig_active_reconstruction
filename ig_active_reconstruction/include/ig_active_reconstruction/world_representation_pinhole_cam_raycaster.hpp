...
public:
  ...
  public:
    ...
    Eigen::Matrix3d
        camera_matrix; //! (Intrinsic) camera matrix [px]. Default: Identity.
  };
...
protected:
  /*! (Re-)computes the internal camera coordinate relative ray direction set,
   * given
...
protected:
  ...
  boost::shared_ptr<RayDirectionSet> ray_directions_; //! Precomputed set of ray
