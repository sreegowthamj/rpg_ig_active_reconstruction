...
class PinholeCamRayCaster : public RayCaster
{
      public:
        struct ResolutionSettings {
              ...
              public:
                ...
                double ray_resolution_y; //! How many rays are cast per pixel on
                                         ...
                                         //! information. [rays/px] Default: 1.0
                double min_x_perc; //! Minimum x to be cast [%of image width].
                                   //! Default:0.
                double min_y_perc; //! Minimum y to be cast [%of image height].
                                   //! Default:0.
                double max_x_perc; //! Maximum x to be cast [%of image width].
                                   //! Default:1.
                double max_y_perc; //! Maximum y to be cast [%of image height].
                                   //! Default:1.
        };
        ...
        struct Config {
              ...
              public:
                ...
                Eigen::Matrix3d camera_matrix; //! (Intrinsic) camera matrix
                                               //! [px]. Default: Identity.
        };
      ...
      public:
        ...
        /*! Projects 2d-image coordinates to 3d-ray direction using the camera
         * matrix. The direction is normalized.
         *
        ...
        getRaySet(movements::Pose &sensor_pose);
        ...
        getRayDirectionSet(movements::Pose &sensor_pose);
        ...
        getRelRayDirectionSet() const;

      protected:
        /*! (Re-)computes the internal camera coordinate relative ray direction
         * set, given the current configuration.
         */
      ...
      protected:
        ...
        boost::shared_ptr<RayDirectionSet>
                ray_directions_; //! Precomputed set of ray directions relative
                                 //! to the camera (sensor) coordinate frame.
};
