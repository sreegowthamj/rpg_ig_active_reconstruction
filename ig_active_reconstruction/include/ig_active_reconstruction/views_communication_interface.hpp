...
public:
  enum struct ViewSpaceStatus { OK, BAD, NONE_AVAILABLE };

  enum struct ViewSpaceUpdateResult { SUCCEEDED = 0, FAILED, NOT_AVAILABLE };
...
public:
  ...
  deleteViews(std::vector<View::IdType> &view_ids) = 0;
