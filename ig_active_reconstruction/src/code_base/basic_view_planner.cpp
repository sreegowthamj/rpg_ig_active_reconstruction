...
void BasicViewPlanner::pause() { pauseProcedure_ = true; }

void BasicViewPlanner::stop() { runProcedure_ = false; }

BasicViewPlanner::Status BasicViewPlanner::status() { return status_; }
  ...
  do {
    ...
    do {
      ...
      pausePoint();
             ...
             robot::CommunicationInterface::ReceptionInfo::SUCCEEDED);
    ...
    views::View::IdType nbv_id =
        utility_calculator_->getNbv(view_candidate_ids, viewspace_);
