    ...
    : public ig_active_reconstruction::robot::CommunicationInterface
{
      ...
      public:
         ...
         * publication.
         * @param controller Sets the controller of the camera that will be
         * moved.
         * @param in_name Input name (Where pcl input is retrieved, relative to
         * node namespace)
         * @param out_name How outputs (srv/topic) are advertised (relative to
         * node namespace)
         */
